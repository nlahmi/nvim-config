...
vim.keymap.set("n", "<leader>gA", "<cmd>redir @z<cr><cmd>!gh auth switch<cr><cmd>redir END<cr><cmd>reg z<cr>", { desc = "GH Auth Switch" })
...
vim.keymap.set("n", "<leader>rk", "<cmd>redir @z<cr><cmd>!kubectl apply -f %<cr><cmd>redir END<cr><cmd>reg z<cr>", { desc = "Kubectl Apply Current File" })
vim.keymap.set("n", "<leader>rc", "<cmd>redir @z<cr><cmd>!chezmoi apply<cr><cmd>redir END<cr><cmd>reg z<cr>", { desc = "Chezmoi Apply" })

vim.keymap.set("n", "<leader>rf", "<cmd>redir @z<cr><cmd>!acli mani-pedi --file %<cr><cmd>redir END<cr><cmd>reg z<cr>", { desc = "ACLI Mani Pedi (current file)" })
vim.keymap.set("n", "<leader>rF", "<cmd>redir @z<cr><cmd>!acli mani-pedi<cr><cmd>redir END<cr><cmd>reg z<cr>", { desc = "ACLI Mani Pedi (entire project)" })
